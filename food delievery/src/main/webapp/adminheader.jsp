    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
       ...
       <!--  <li class="dropdown">
        ...
        <li class="active"><a href="addmess.jsp">Add Mess / Restaurant</a></li>
         <li class="active"><a href="viewmess.jsp">View Mess</a></li>
        <li class="active"><a href="viewRest.jsp">View Restaurant</a></li>
        <li class="active"><a href="viewMessOrder.jsp" class="btn btn-info">Restaurant / Mess Order</a></li>
