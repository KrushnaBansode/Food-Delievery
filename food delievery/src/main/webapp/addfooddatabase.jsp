...
<body>
	<%
		MultipartRequest m = new MultipartRequest(request, Path.addfoodpath, 1048 * 1048 * 1048);
		...
		String messOR=m.getParameter("whichRes");
		...
		String sql = "insert into addfood(name,description,price,photo,status,messorrest,messOR)values(?,?,?,?,?,?,?)";
